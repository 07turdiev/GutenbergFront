      ...
      <div className="bg-[#f3f4f6] rounded-lg py-12 lg:py-16 px-6 lg:px-12">
        <div className="flex justify-between items-center flex-col lg:flex-row gap-8 lg:gap-0">
          ...
          <a href="https://t.me/gutenbergnu_bot" target="_blank" rel="noopener noreferrer"
            className="group flex items-center border-2 border-[#cd1b17] rounded-[60px] py-4 px-5 lg:py-3 lg:px-6 text-black text-xl lg:text-2xl font-medium no-underline hover:bg-[#cd1b17] hover:text-white transition-colors duration-200"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" width="25" height="25"
              viewBox="0 0 18 18" 
              className="w-12 h-12 lg:w-14 lg:h-14 mr-4 lg:mr-5 fill-[#cd1b17] group-hover:fill-white transition-colors duration-200"
            >
