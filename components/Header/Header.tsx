            ...
            <div className='container mx-auto px-3 relative z-30'>
                <div className="grid grid-cols-12 items-center">
                    <div className="lg:col-span-2 col-span-4">
                        <div className='xl:w-44 w-32 cursor-pointer' onClick={()=>router.push('/')}>
                            <SiteLogo/>
                        </div>
                    </div>

                    <div className="lg:col-span-3 col-span-8 lg:order-3 hidden lg:block">
                        <div className="flex items-center ml-auto justify-end pl-5">
                            <LocaleSwitcher/>
                            <div className="mr-3">
                                <SearchBtn/>
                            </div>
                    ...
                    <div className="lg:col-span-7 lg:order-2 col-span-8">
