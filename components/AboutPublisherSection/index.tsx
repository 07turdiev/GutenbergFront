            ...
            <div className={styles.container}>
                ...
                <div className={styles.mobile}>
                    ...
                    <div className={styles.metric}>
                        ...
                        <div className={styles.metricText}>Biz haqimizda</div>
                    </div>

                    {/* Heading + Arrow */}
                    <div className={styles.headingRow}>
                        <h1 className={styles.heading}>Gutenberg nashriyot uyi qanday nashriyot?</h1>
                        <Link href="/about">
                    ...
                    <p className={styles.desc}>
                        Besh asr avval logan Gutenberg o'z ixtirosi bilan kitoblarning ommalashishiga va Uyg'onish davrining boshlanishiga sabab bo'lgan edi. Biz ham o'z oldimizga shunday ulkan maqsad qo'ydik.
                    </p>
                    ...
                    <div className={styles.goals}>
                        <div className={styles.goalsTitle}>Maqsadimiz!</div>
                        <p className={styles.goalsText}>
                            Zamonamizning eng ilg'or g'oyalarini o'zbek tilida yetkazish orqali yangi bir intellektual uyg'onishga o'z hissamizni qo'shmoqchimiz.
                        </p>
                    </div>
                ...
                <div className={styles.desktop}>
                    ...
                    <div className={styles.metricAbs}>
                        ...
                        <div className={styles.metricTextDesk}>Biz haqimizda</div>
                    </div>

                    {/* Main Heading */}
                    <h1 className={styles.headingAbs}>Gutenberg nashriyot uyi qanday nashriyot?</h1>
                    ...
                    <div className={styles.contentAbs}>
                        {/* Content Title */}
                        <div className={styles.contentTitleAbs}>Maqsadimiz!</div>

                        {/* Content Text */}
                        <div className={styles.contentTextAbs}>
                            Zamonamizning eng ilg'or g'oyalarini o'zbek tilida yetkazish orqali yangi bir intellektual uyg'onishga o'z hissamizni qo'shmoqchimiz.
                        </div>
                        ...
                        <Link href="/contact">
                            <a className={styles.ctaAbs}>
                                <span className={styles.ctaTextAbs}>Biz bilan aloqa</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <path d="M1 0.999268H13M13 0.999268V12.9993M13 0.999268L1 12.9993" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </a>
